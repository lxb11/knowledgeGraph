...
class BertIntentModel(object):
    def __init__(self):
        ...
        self.dict_path = 'E:/01.code/02.ml/knowledgeGraph/roberta/vocab.txt'
        self.config_path = 'E:/01.code/02.ml/knowledgeGraph/roberta/bert_config_rbt3.json'
        self.checkpoint_path = 'E:/01.code/02.ml/knowledgeGraph/roberta/bert_model.ckpt'
